...
<template>
        ...
        <div :class="socialMediaListClasses">
            ...
            <a class="social-media-list__item" href="https://api.whatsapp.com/send/?phone=79222475444" @click = "toggleSocialMediaList()"> 
            ...
            <a class="social-media-list__item" href="mailto:ramazan_M_I@mail.ru" @click = "toggleSocialMediaList()"> 
            ...
            <a class="social-media-list__item" href="tel:+79222475444" @click = "toggleSocialMediaList()">
