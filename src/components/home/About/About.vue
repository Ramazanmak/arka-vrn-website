    ...
    <div id="about" class="achievements">
        <section class="achievements__item">
            ...
            <p class="achievements__item-text achievements__item-text_straight">
                Уже более 25 лет мы занимаемся изготовлением бетонных изделий.Каждая технология отрабатывается многолетним опытом и доводится до совершенства. Наша политика - работать на качество изделий. А наша цель - делать улицы нашей Родины красивее и чище.
            </p>
